...
- [ ] 🟡 **Démarrer la collecte de preuves SOC 2**. *(continu)* — **Élargie le 05/09/2026** : les 6 services prévus par la conception §10.7 sont désormais audités (voir item J ci-dessus), la période d'observation SOC 2 Type II est donc significative pour tout ce périmètre depuis cette date. Reste hors périmètre par construction (Reporting/Notification) ou toujours à zéro (§I observabilité) — **c'est toujours ce dernier point, seul, qui ferait échouer un Type II aujourd'hui** (CC7).
...
| 🟠 P1 | 34 | 25 | 3 | 0 | 6 | M (+ 2 L : paiement en ligne fait (sandbox) — PR #192, outbox fait — PR #191, périmètre facturation→paiement uniquement ; avoir/rectification fait ; piste d'audit sur 6/6 services + immuabilité réelle paiement/facturation — PR #205/#208/#210/#212/#215) |
| 🟡 P2 | 21 | 20 | 0 | 0 | 1 | S/M (+ 1 L : réplication PostgreSQL, fait en PoC — PR #173) |
| 🟢 P3 | 15 | 9 | 0 | 5 | 1 | M/L (RGPD étendu aux utilisateurs internes + rétention 3 ans — PR #213) |
| **Total** | **97** | **80 (82 %)** | **3 (3 %)** | **6 (6 %)** | **8 (8 %)** | — |
